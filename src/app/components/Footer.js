  ...
  return (
    <footer className="pt-20 bg-white z-20">
      <div className="container mx-auto mb-24">
        <motion.div variants={fadeIn('up', 0.2)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.4 }} className="flex flex-col lg:flex-row lg:justify-between gap-x-5 gap-y-14">
          <div className="flex flex-col flex-1 gap-y-8">
            <Link to={"home"} smooth={true} spy={true} className="cursor-pointer"> 
              <Image src={"/icons/logo.svg"} width={200} height={200} alt=""/> 
            </Link>
            <div className="text-secondary">Velit voluptate esse irure tempor.</div>
            <div className="flex flex-col gap-y-4 font-semibold">
              <div className="flex items-center gap-x-[10px]">
                <FaPhone/>
                <div className="font-medium">(254)740-800-940</div>
              </div>
              <div className="flex items-center gap-x-[10px]">
                <FaEnvelope/>
                <div className="font-medium">muthondugithinji@gmail.com</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="mb-9 text-secondary">
              Cupidatat ea consectetur consectetur proident incididunt ea laboris eu cillum.
            </div>
            <form className="flex gap-x-2 h-14">
              <input type="text" placeholder="Enter Your Email" className="outline-none bg-white h-full border rounded-lg pl-4 focus:border-accent"/>
